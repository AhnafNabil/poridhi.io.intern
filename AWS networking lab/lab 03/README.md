...
![](https://github.com/Galadon123/poridhi.io.intern/blob/fazlul/AWS%20networking%20lab/lab%2003/images/diagram-export-7-11-2024-8_35_04-PM.png)
...
3. **Create the Private Subnet:**
   ...
   ![](https://github.com/Galadon123/poridhi.io.intern/blob/fazlul/AWS%20networking%20lab/lab%2003/images/3.png)
...
5. **Create the Private Route Table:**
   ...
   ![](https://github.com/Galadon123/poridhi.io.intern/blob/fazlul/AWS%20networking%20lab/lab%2003/images/11.png)
...
6. **Associate Private Route Table with Private Subnet:**
   ...
   ![](https://github.com/Galadon123/poridhi.io.intern/blob/fazlul/AWS%20networking%20lab/lab%2003/images/12.png)
...
5. **Verify Resources:**
   ...
   ![](https://github.com/Galadon123/poridhi.io.intern/blob/fazlul/AWS%20networking%20lab/lab%2003/images/16.png)
...
2. **Launch Private EC2 Instance:**
   ...
   ![](https://github.com/Galadon123/poridhi.io.intern/blob/fazlul/AWS%20networking%20lab/lab%2003/images/20.png)
...
1. **Copy the content of public key from the  directory containing `private-key-pair.pem` file :**
   ...
   ![](https://github.com/Galadon123/poridhi.io.intern/blob/fazlul/AWS%20networking%20lab/lab%2003/images/33.png)
...
3. **Connect to the Private EC2 Instance:**
   ...
   - Run the following command to connect to the instance (replace `<ec2-instance-2-public-IP>` with your instance's private IP address):
     ...
     ![](https://github.com/Galadon123/poridhi.io.intern/blob/fazlul/AWS%20networking%20lab/lab%2003/images/34.png)
